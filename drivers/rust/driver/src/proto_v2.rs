...
pub struct InitPluginSuccess {
    ...
    pub plugin_capabilities: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
/// Failure result of initialising the plugin
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct InitPluginFailure {
    ...
    #[prost(string, repeated, tag = "2")]
    pub missing_host_capabilities: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
}
...
pub struct InitPluginResponse {
    #[prost(oneof = "init_plugin_response::Response", tags = "1, 2")]
    pub response: ::core::option::Option<init_plugin_response::Response>,
}
/// Nested message and enum types in `InitPluginResponse`.
pub mod init_plugin_response {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Response {
        #[prost(message, tag = "1")]
        Success(super::InitPluginSuccess),
        #[prost(message, tag = "2")]
        Failure(super::InitPluginFailure),
    }
}
