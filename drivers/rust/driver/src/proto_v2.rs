...
pub mod catalogue_entry {
  ...
  impl EntryType {
    ...
    pub fn as_str_name(&self) -> &'static str {
      match self {
        Self::ContentMatcher => "CONTENT_MATCHER",
        Self::ContentGenerator => "CONTENT_GENERATOR",
...
pub struct InteractionResponse {
  ...
  pub metadata_rules: ::std::collections::HashMap<::prost::alloc::string::String, MatchingRules>,
  /// Generators to apply to any message metadata
  #[prost(map = "string, message", tag = "10")]
  pub metadata_generators: ::std::collections::HashMap<::prost::alloc::string::String, Generator>,
}
...
pub mod pact_plugin_client {
    ...
    <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
  {
    ...
    pub async fn init_plugin(
    ...
    ) -> std::result::Result<tonic::Response<super::InitPluginResponse>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      let path = http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/InitPlugin");
    ...
    pub async fn update_catalogue(
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/UpdateCatalogue");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "UpdateCatalogue",
    ...
    pub async fn compare_contents(
    ...
    ) -> std::result::Result<tonic::Response<super::CompareContentsResponse>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/CompareContents");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "CompareContents",
    ...
    ) -> std::result::Result<tonic::Response<super::ConfigureInteractionResponse>, tonic::Status>
    {
      self
        .inner
        .ready()
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/ConfigureInteraction");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
    ...
    pub async fn generate_content(
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/GenerateContent");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "GenerateContent",
    ...
    pub async fn start_mock_server(
    ...
    ) -> std::result::Result<tonic::Response<super::StartMockServerResponse>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/StartMockServer");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "StartMockServer",
    ...
    ) -> std::result::Result<tonic::Response<super::ShutdownMockServerResponse>, tonic::Status>
    {
      self
        .inner
        .ready()
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/ShutdownMockServer");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "ShutdownMockServer",
    ...
    pub async fn get_mock_server_results(
    ...
    ) -> std::result::Result<tonic::Response<super::MockServerResults>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/GetMockServerResults");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
    ...
    ) -> std::result::Result<tonic::Response<super::VerificationPreparationResponse>, tonic::Status>
    {
      self
        .inner
        .ready()
    ...
    pub async fn verify_interaction(
    ...
    ) -> std::result::Result<tonic::Response<super::VerifyInteractionResponse>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      let codec = tonic_prost::ProstCodec::default();
      let path =
        http::uri::PathAndQuery::from_static("/io.pact.plugin.v2.PactPlugin/VerifyInteraction");
      let mut req = request.into_request();
      req.extensions_mut().insert(GrpcMethod::new(
        "io.pact.plugin.v2.PactPlugin",
        "VerifyInteraction",
...
pub mod pact_plugin_server {
  ...
  #[async_trait]
  pub trait PactPlugin: std::marker::Send + std::marker::Sync + 'static {
    /// Check that the plugin loaded OK. Returns the catalogue entries describing what the plugin provides
      ...
      match req.uri().path() {
        "/io.pact.plugin.v2.PactPlugin/InitPlugin" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::InitPluginRequest> for InitPluginSvc<T> {
            ...
            fn call(&mut self, request: tonic::Request<super::InitPluginRequest>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::init_plugin(&inner, request).await };
              Box::pin(fut)
            }
          }
        ...
        "/io.pact.plugin.v2.PactPlugin/UpdateCatalogue" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::Catalogue> for UpdateCatalogueSvc<T> {
            type Response = ();
            type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
            fn call(&mut self, request: tonic::Request<super::Catalogue>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::update_catalogue(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/CompareContents" => {
            ...
            for CompareContentsSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::compare_contents(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/ConfigureInteraction" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::ConfigureInteractionRequest>
            for ConfigureInteractionSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut =
                async move { <T as PactPlugin>::configure_interaction(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/GenerateContent" => {
            ...
            for GenerateContentSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::generate_content(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/StartMockServer" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::StartMockServerRequest>
            for StartMockServerSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::start_mock_server(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/ShutdownMockServer" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::ShutdownMockServerRequest>
            for ShutdownMockServerSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut =
                async move { <T as PactPlugin>::shutdown_mock_server(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/GetMockServerResults" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::MockServerRequest>
            for GetMockServerResultsSvc<T>
          {
            type Response = super::MockServerResults;
            type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
            fn call(&mut self, request: tonic::Request<super::MockServerRequest>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut =
                async move { <T as PactPlugin>::get_mock_server_results(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/io.pact.plugin.v2.PactPlugin/PrepareInteractionForVerification" => {
          #[allow(non_camel_case_types)]
          struct PrepareInteractionForVerificationSvc<T: PactPlugin>(pub Arc<T>);
          impl<T: PactPlugin> tonic::server::UnaryService<super::VerificationPreparationRequest>
            for PrepareInteractionForVerificationSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move {
                <T as PactPlugin>::prepare_interaction_for_verification(&inner, request).await
              };
              Box::pin(fut)
            }
          }
        ...
        "/io.pact.plugin.v2.PactPlugin/VerifyInteraction" => {
          ...
          impl<T: PactPlugin> tonic::server::UnaryService<super::VerifyInteractionRequest>
            for VerifyInteractionSvc<T>
          {
            ...
            fn call(
              ...
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as PactPlugin>::verify_interaction(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
  ...
  impl<T> Clone for PactPluginServer<T> {
    fn clone(&self) -> Self {
      let inner = self.inner.clone();
      Self {
        inner,
  ...
  pub const SERVICE_NAME: &str = "io.pact.plugin.v2.PactPlugin";
  impl<T> tonic::server::NamedService for PactPluginServer<T> {
