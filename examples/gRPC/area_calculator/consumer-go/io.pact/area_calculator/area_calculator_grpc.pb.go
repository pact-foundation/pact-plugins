...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *ShapeMessage, opts ...grpc.CallOption) (*AreaResponse, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *ShapeMessage, opts ...grpc.CallOption) (*AreaResponse, error) {
	out := new(AreaResponse)
	err := c.cc.Invoke(ctx, "/area_calculator.Calculator/calculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	Calculate(context.Context, *ShapeMessage) (*AreaResponse, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *ShapeMessage) (*AreaResponse, error) {
...
func _Calculator_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/area_calculator.Calculator/calculate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calculate(ctx, req.(*ShapeMessage))
	}
